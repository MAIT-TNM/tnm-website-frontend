...
const Navbar = () => {
  ...
  return (
    <nav className="w-full md:w-[90%] lg:w-[80%] xl:w-[70%] 2xl:w-[60%] sm:p-10 md:left-[5%] lg:left-[10%] xl:left-[15%] 2xl:left-[20%] md:rounded-[10rem] md:border-[1px] md:border-customGray md:p-5 md:container md:mt-[1.7rem] md:backdrop-blur-[5px] transition-all duration-500 ease-in fixed top-0 z-[9999] bg-transparent md:shadow-2xl">
